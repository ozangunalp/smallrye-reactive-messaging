...
@ConnectorAttribute(name = "health-topic-verification-startup-disabled", type = "boolean", direction = Direction.INCOMING_AND_OUTGOING, description = "Whether the topic verification is disabled for the startup health check.", defaultValue = "false")
@ConnectorAttribute(name = "health-topic-verification-readiness-disabled", type = "boolean", direction = Direction.INCOMING_AND_OUTGOING, description = "Whether the topic verification is disabled for the readiness health check.", defaultValue = "false")
...
@ConnectorAttribute(name = "throttled.metadata-for-offsets.bytes", type = "int", direction = Direction.INCOMING, description = "The maximum number of bytes allowed for serializing out-of-order offsets. A value of 0 effectively disables this feature.", defaultValue = "0")
@ConnectorAttribute(name = "throttled.processing-order", type = "string", direction = Direction.INCOMING, description = "Possible values: unordered, ordered-by-key, ordered-by-partition", defaultValue = "unordered")
